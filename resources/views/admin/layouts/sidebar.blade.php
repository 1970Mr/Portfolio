<section x-cloak class="sidebar" :class="open || 'inactive'">
  ...
  <div class="mt-4">
    <ul class="list-unstyled">
      ...
      <li x-data="{{ active_route('admin.panel.about') == 'active' ? '{dropdown, open: true}' : 'dropdown' }}" class="sidebar-item">
        ...
        <ul x-show="open" x-transition class="submenu">
          <li class="submenu-item {{ active_route('admin.panel.about.personal') }}">
