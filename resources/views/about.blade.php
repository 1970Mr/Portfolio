...
<section class="main-content revealator-slideup revealator-once revealator-delay1">
    <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ul class="about-list list-unstyled open-sans-font">
                            <li> <span class="title">نام :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">امیر حسین</span> </li>
                            <li> <span class="title">نام خاوادگی :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">دامن دریا</span> </li>
                            <li> <span class="title">سن :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">20 سال</span> </li>
                            <li> <span class="title">ملیت :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">ایران</span> </li>
                            <li> <span class="title">شغل :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">طراح سایت</span> </li>
                        </ul>
                    </div>
                    <div class="col-6">
                        <ul class="about-list list-unstyled open-sans-font">
                            <li> <span class="title">آدرس :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">یزد</span> </li>
                            <li> <span class="title">تلفن :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">+98013234324</span> </li>
                            <li> <span class="title">ایمیل  :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">you@mail.com</span> </li>
                            <li> <span class="title">اسکایپ :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">steve.milner</span> </li>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="box-stats">
                            ...
                            <p class="open-sans-font m-0 position-relative text-uppercase">جایزه <span class="d-block">برنده شده</span></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="text-uppercase pb-5 mb-0 text-left text-sm-center custom-title ft-wt-600">تجربه  <span>&</span> تحصیلات </h3>
            </div>
                ...
                <div class="resume-box">
                    <ul>
                        <li>
                            ...
                            <h5 class="poppins-font text-uppercase">طراحی سایت <span class="place open-sans-font">راستچین</span></h5>
                        ...
                        <li>
                            ...
                            <h5 class="poppins-font text-uppercase">UI/UX طراح <span class="place open-sans-font">راستچین</span></h5>
                            <p class="open-sans-font">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
                        </li>
                        <li>
                            <div class="icon">
                ...
                <div class="resume-box">
                    <ul>
                        <li>
                            ...
                            <h5 class="poppins-font text-uppercase">مدرک مهندسی <span class="place open-sans-font">دانشگاه. ...</span></h5>
                            <p class="open-sans-font">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ</p>
                        </li>
                        <li>
                            <div class="icon">
