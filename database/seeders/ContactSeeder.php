...
class ContactSeeder extends Seeder
{
    ...
    public function run()
    {
        Contact::create([
            ...
            خیلی خوشحالم که اینجا هستی و می‌خوای با من ارتباط برقرار کنی. داشتن ارتباط با شما برای من ارزشمنده و همیشه به دنبال شنیدن حرف‌های شما هستم.
            ...
            بی‌خیال پیام‌های رسمی باش، فقط برام یه پیام ساده بنویس. هر چی که تو دلته رو بهم بگو. مطمئن باش که همه پیام‌هاتو با احترام می‌خونم و تلاش می‌کنم بهشون بهترین پاسخ رو بدم.
